  ...
  return (
        <div className='navigation' ref={NavigationBar}>
            <div className='navigation__right'>
              ...
              <button className={ sidebar ? "navigation__hamburger navigation__hamburger--active" : "navigation__hamburger" } onClick={()=>setSidebar(!sidebar)} aria-label="Main Menu">

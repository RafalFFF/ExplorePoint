...
import SearchFomr from '../Forms/SearchFomr';

const NavBar = ()=>{

  const context = useContext(AppContext);
  
  const {darkMode,setDarkMode, setIsModalOpen,setFormType} = context;
  ...
  return (
        <div className='navigation' ref={NavigationBar}>
          <div className={darkMode ? 'navigation__wrapper navigation__wrapper--dark-mode' : 'navigation__wrapper'}>
            ...
            <button onClick={()=>setSidebar(!sidebar)} className={ sidebar ? "navigation__hamburger navigation__hamburger--active" : "navigation__hamburger" } onClick={()=>setSidebar(!sidebar)} aria-label="Main Menu">
                <svg width="32px" height="32px" viewBox="0 0 100 100">
                  <path className={ darkMode ? "line--dark-mode line1" :"line line1"} d="M 20,29.000046 H 80.000231 C 80.000231,29.000046 94.498839,28.817352 94.532987,66.711331 94.543142,77.980673 90.966081,81.670246 85.259173,81.668997 79.552261,81.667751 75.000211,74.999942 75.000211,74.999942 L 25.000021,25.000058" />
                  <path className={ darkMode ? "line--dark-mode line2" :"line line2"} d="M 20,50 H 80" />
                  <path className={ darkMode ? "line--dark-mode line3" :"line line3"} d="M 20,70.999954 H 80.000231 C 80.000231,70.999954 94.498839,71.182648 94.532987,33.288669 94.543142,22.019327 90.966081,18.329754 85.259173,18.331003 79.552261,18.332249 75.000211,25.000058 75.000211,25.000058 L 25.000021,74.999942" />
                </svg>
            </button>
            <span className={darkMode ? 'navigation__site-name  navigation__site-name--dark-mode' : 'navigation__site-name'}>ExplorePoint</span>
            </div>
            <div className="navigation__left">
                <SearchFomr dupa={mobileSearch} />
                <div className={darkMode ? 'navigation__notifications navigation__notifications--dark-mode' : 'navigation__notifications'}>
                  <svg width="32px" height="32px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" clipRule="evenodd" d="M6.31317 12.463C6.20006 9.29213 8.60976 6.6252 11.701 6.5C14.7923 6.6252 17.202 9.29213 17.0889 12.463C17.0889 13.78 18.4841 15.063 18.525 16.383C18.525 16.4017 18.525 16.4203 18.525 16.439C18.5552 17.2847 17.9124 17.9959 17.0879 18.029H13.9757C13.9786 18.677 13.7404 19.3018 13.3098 19.776C12.8957 20.2372 12.3123 20.4996 11.701 20.4996C11.0897 20.4996 10.5064 20.2372 10.0923 19.776C9.66161 19.3018 9.42346 18.677 9.42635 18.029H6.31317C5.48869 17.9959 4.84583 17.2847 4.87602 16.439C4.87602 16.4203 4.87602 16.4017 4.87602 16.383C4.91795 15.067 6.31317 13.781 6.31317 12.463Z" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M9.42633 17.279C9.01212 17.279 8.67633 17.6148 8.67633 18.029C8.67633 18.4432 9.01212 18.779 9.42633 18.779V17.279ZM13.9757 18.779C14.3899 18.779 14.7257 18.4432 14.7257 18.029C14.7257 17.6148 14.3899 17.279 13.9757 17.279V18.779ZM12.676 5.25C13.0902 5.25 13.426 4.91421 13.426 4.5C13.426 4.08579 13.0902 3.75 12.676 3.75V5.25ZM10.726 3.75C10.3118 3.75 9.97601 4.08579 9.97601 4.5C9.97601 4.91421 10.3118 5.25 10.726 5.25V3.75ZM9.42633 18.779H13.9757V17.279H9.42633V18.779ZM12.676 3.75H10.726V5.25H12.676V3.75Z" fill="#000"/>
                  </svg>
                </div>
                ...
                <div className={ darkMode ? 'navigation__account navigation__account--dark-mode ' : 'navigation__account' }onClick={()=>setUserPanel(!userPanel)}>
                  ...
                  <div className={userPanel ? 'navigation__user-options navigation__user-options--active':'navigation__user-options'}>
                      <span onClick={()=>openModal('login')}>Zaloguj się</span>
                      <span onClick={()=>openModal('register')}>Zarejestruj się</span>
                  </div>
                </div>
            </div> 
            </div>

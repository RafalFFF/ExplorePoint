...
const NavBar = ()=>{
  ...
  const {darkMode,setDarkMode, isModalOpen, setIsModalOpen} = context;
        ...
        <div className='navigation' ref={NavigationBar}>
          <div className="navigation__wrapper">
            ...
            <div className="navigation__left">
                ...
                <div className='navigation__account' onClick={()=>setUserPanel(!userPanel)}>
                  ...
                  <div className={userPanel ? 'navigation__user-options navigation__user-options--active':'navigation__user-options'}>
                      <span onClick={()=>setIsModalOpen(true)}>Zaloguj się</span>
                      <span onClick={()=>setIsModalOpen(true)}>Zarejestruj się</span>
                  </div>
                </div>
            </div> 
            </div>
